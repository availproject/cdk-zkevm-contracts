...
import {IAvailVectorx} from "./IAvailVectorx.sol";
...
interface IAvailBridge {
    ...
    function vectorx() external view returns (IAvailVectorx);
    function setPaused(bool status) external;
    function updateVectorx(IAvailVectorx newVectorx) external;
